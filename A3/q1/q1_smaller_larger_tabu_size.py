...
def TS(initialSolution, tabuTenure):
...
print("tabu list size =", smallerTabuTenure)
bestSolution = TS(initialSolution, smallerTabuTenure)
print(bestSolution)
print("cost:", cost(bestSolution))

print("tabu list size =", largerTabuTenure)
bestSolution = TS(initialSolution, largerTabuTenure)
print(bestSolution)
print("cost:", cost(bestSolution))